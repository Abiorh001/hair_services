    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('two_factor_auth_token', models.CharField(blank=True, max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('user_subscription', models.CharField(choices=[('free', 'Free'), ('premium', 'Premium')], default='free', max_length=50)),
